  ...
  return (
    <>
      <div className="fixed z-10 inset-0 overflow-y-auto mt-12">
                      ...
                      <div className='mt-8'>
                      <textarea name="" id="" cols="30" rows="5" className='border mt-2 mb-6 py-1.5 px-2 rounded-md w-full focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600'
                        value={jobdesc} 
                        onChange={e => setJobDesc(e.target.value)} ></textarea> 
                              ...
                              <div class="p-0.5 inline-block rounded bg-gradient-to-b from-[#0909E9] to-[#00D4FF]" onClick={closeJobDesc}>
