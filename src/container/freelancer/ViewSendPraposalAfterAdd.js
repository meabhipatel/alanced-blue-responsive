  ...
  return (
    <>
      <div className=" container-sm px-36">
        ...
        <h1 className="font-inter text-2xl text-left mt-10">
          Proposal Details
        </h1>
        <div className=" flex flex-row">
            ...
            <div className=" mt-8  border border-[#E7E8F2] py-8 px-8 rounded-lg">
              ...
              <div className=" flex flex-row mt-6">
                <div className=" basis-8/12">
                  ...
                  <div className=" flex flex-row">
                    <div className=" basis-5/12 mt-5">
                      <div class="focus:outline-none  bg-[#b4d3c3] hover:bg-[#c1e2d1]  rounded-xl text-sm font-semibold text-blue-800 py-[3px] dark:bg-[#dffdee] dark:hover:bg-[#dffdee]  bg-opacity-[60%]">
                    ...
                    <div className=" basis-4/12 mt-5 ml-2">
                      <p className=" text-sm font-medium font-inter text-left opacity-[50%]">
                        Posted{" "}
                        {timeAgo(projectdata.project.project_creation_date)}
                      </p>
                    </div>
                  </div>
              ...
              <div>
                ...
                <p className="text-base font-medium font-inter text-left mt-5 opacity-70">
                  $ {addedbid.bid_amount - addedbid.bid_amount / 10}
                </p>
          ...
          <div className=" basis-3/12">
            ...
            <div className="mt-5 ml-7">
              ...
              <p className="text-[15px] font-inter font-normal opacity-75 mt-2 text-left">
                {projectdata.project.project_owner_name}
              </p>
            ...
            <div className="mt-5 ml-7">
              ...
              <p className="text-[15px] font-inter font-normal opacity-75 mt-2 text-left">
                {projectdata.project.project_owner_location}
              </p>
              {/* <p className='text-[15px] font-inter font-normal opacity-75  text-left'>kathmandu 04:42 PM</p> */}
            </div>
            <div className="mt-5 ml-7">
              ...
              <p className="text-[12px] font-inter font-normal opacity-75 mt-2 text-left">
                Member since{" "}
                {projectdata.project.project_owner_date_of_creation}
              </p>
            </div>
          </div>
        </div>
