...
const SelfBidProject = () => {
  ...
  const normaltime =
    BidData && format(new Date(BidData.project.created_at), "yyyy-MM-dd HH:mm");
            ...
            <div className=" basis-9/12">
              <div className=" mt-8  border border-[#E7E8F2] py-8 px-8 rounded-lg">
                    ...
                    <div className=" flex flex-row ml-4">
                      ...
                      <div className=" basis-6/12">
                        <p className=" text-[14px] font-normal text-left">
                          {BidData.project.experience_level.replace(/_/g, " ")}
                        </p>
                ...
                <div className="text-left mt-5">
                  {JSON.parse(
                    BidData.project.skills_required.replace(/'/g, '"')
                  ).map((skill, index) => (
                ...
                <div className=" flex flex-row">
                  ...
                  <div className=" basis-6/12">
                    <p className="text-base font-medium opacity-50 font-inter text-right mt-5">
                      Client's budget: $
                      {BidData.project.rate == "Hourly"
                        ? BidData.project.min_hourly_rate +
                          "/hr" +
                          " - " +
                          "$" +
                          BidData.project.max_hourly_rate +
                          "/hr"
                        : BidData.project.fixed_budget}
                    </p>
                  </div>
                </div>
                <div>
                  ...
                  <p className="text-base font-medium font-inter text-left mt-5 opacity-70">
                    {BidData.bid_amount - BidData.bid_amount / 10}
                  </p>
          ...
          {BidData != null ? (
            <div className=" basis-3/12">
              ...
              <div className="mt-5 ml-7">
                ...
                <p className="text-[15px] font-inter font-normal opacity-75 mt-2 text-left">
                  {BidData.project.project_owner_Name}
                </p>
              ...
              <div className="mt-5 ml-7">
                ...
                <p className="text-[15px] font-inter font-normal opacity-75 mt-2 text-left">
                  {BidData.project.project_owner_location}
                </p>
                {/* <p className='text-[15px] font-inter font-normal opacity-75  text-left'>kathmandu 04:42 PM</p> */}
              </div>
              <div className="mt-5 ml-7">
                ...
                <p className="text-[12px] font-inter font-normal opacity-75 mt-2 text-left">
                  Member since {BidData.project.project_owner_date_of_creation}
                </p>
              </div>
            </div>
          ) : (
