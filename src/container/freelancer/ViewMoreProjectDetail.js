        ...
        <div className=" flex flex-row my-6">
          ...
          <div className=" basis-4/12">
            <div className="mt-6 ml-[16%]">
              {/* <Link to="/freelancer/send-proposal" style={{pointerEvents: clickable ? 'none' : ''}} state={{ projectData }} ><span class={clickable ? 'px-12 py-[15px] lg:mt-0 bg-slate-200 border rounded border-none text-white font-inter text-base font-normal':'px-12 py-[15px] lg:mt-0 bg-gradient-to-r from-[#0909E9] to-[#00D4FF] border rounded border-none text-white font-inter text-base font-normal'}>Apply Now</span></Link> */}
              {accessToken ? (
                <Link
